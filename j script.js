...
// //       seconds = 20
// // const seconds = 30
// // console.log(seconds) // Error:identifier has been already declared     

// // //10. Write difference between var and let.

// // var:it can be declared ,initialize ,reuse ,redeclare and reinitialized.
// // let:it can be declared ,initialize ,reuse and reinitialized only it cannot be redeclared.

// // //11. Write difference between let and const.

// // let:it can be declared ,initialize ,reuse and reinitialized only it cannot be redeclared.
// // constant:it can be declared and initialize once only it cannot be reused ,redeclared or reinitialized.
...
// // console.log(z)//Error:we canot reuse redeclare or reinitialize it is fixed one 

// // //35. Create alert box with your college name.
// // alert("Kongu arts and science college")
...
// //     var can declared without value
// //     var can be changes anywhere 
// //     var has a function scope

// // //50. Write rules of let and const.
// //     let can be reassigned
// //     let cannot be redeclared
// //     let cannot declared without value
...
// // let animals =["Dog","Cat","Deer","Rabbit","Lion","Tiger"]
// // console.log(animals)
...
// // let citi=["Tirupur","Erode","Coimbatore","Salem","Chennai","Banglore"]
// // console.log(citi[2])

// // // 35. Create one object with employee details and print employee name.

// // let employee={name:"sathish",code:12345,domain:"software"}
// // console.log(employee.name)

// // // 36. Create variable with string "100" and print typeof.

// // let str="100"
// // console.log(typeof(str))//srting
